...
$koniec=$wynik[2];
  ...
  wyslijmail($q,$qu,$zam,$ad,$comm,$ver,$user,$tab_zmian,$start,$koniec);
...
function wyslijmail($war2,$col2,$subject,$to,$comm,$ver,$user,$tab_zmian,$start,$koniec){
  //print_r($subject);
...
if ($ver>1){
  $mail->Body     =$mes_user.$tab_zmian.$message.'<br><br>'.$messagePL2;
}else{
    $mail->Body     =$mes_user.$message.$messagePL2;
}
//     $mail->Body     = $messagePL;
