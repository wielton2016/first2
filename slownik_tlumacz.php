...
$tlumacz=tlumacz_grup2();// słownik z cenami [0] to [eng]=pl; [1] tp [eng]= cena
$opcje=getopcje_nr();
$list=loadorder0();
...
echo "<table id='tabela_slo' class='one' style='width:100%' margin-top: 500px>";
  ...
  echo "<td class='two'>ENG</td>" ;
    ...
    //print_r($tlumacz[0]);
for($i=0;$i<count($tlumacz[0]);++$i){
  //print_r($o);
 // foreach($o as $o2){
  // if(empty($tlumacz[0][$o2])){
    //print_r($o);
   // echo "<br>";

        echo"<tr  id='button_".$o2."_".$id_liczy."'>";
        echo "<td class='two'>" .$tlumacz[2][$i]."</td>" ;
        echo "<td class='three'><textarea name='".$o2."_".$id_liczy."' id='PL_".$o2."_".$id_liczy."' style='width:90%;'>".$tlumacz[0][$tlumacz[2][$i]]."</textarea></td>" ;
        echo "<td class='three'><input type='text' name='".$o2."_".$id_liczy."' id='cena_".$o2."_".$id_liczy."' value='".$tlumacz[1][$tlumacz[2][$i]]."'></td>"; 
