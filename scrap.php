...
<?php
 ...
 //  print_r($tytul);
    ...
    echo "<table class='two' style='width:3300px;table-layout:fixed;position:relative ;' margin-top: 500px>"; 
   // naglówki tabeli 
    echo"<tr>";
   ...
   echo"</tr>";
    echo "</table>";
         ...
         echo "<table class='two' style='width:3300px;table-layout:fixed' margin-top: 500px>"; 
   // naglówki tabeli 
    echo"<tr>";
   for($y=0;$y<count($tytul[0]);$y++){
     echo"<th class='one' style='width:150px;' >'".$tytul[0][$y]."'</th>";
